...
public class ElasticsearchTests {
    ...
    @Autowired
    private DiscussPostMapper discussMapper;  // 操作Mysql数据库，把数据存到 ES 里

    @Autowired
    private DiscussPostRepository discussRepository;  // 往 ES 中存取数据

    @Autowired
    private ElasticsearchTemplate elasticTemplate;  // 解决 Repository 解决不了的特殊情况
    ...
    public void testSearchByTemplate() {
        ...
        Page<DiscussPost> page = elasticTemplate.queryForPage(searchQuery, DiscussPost.class, new SearchResultMapper() {
            ...
            public <T> AggregatedPage<T> mapResults(SearchResponse response, Class<T> aClass, Pageable pageable) {
                SearchHits hits = response.getHits();  // 这次搜索命中的数据
                ...
                for (SearchHit hit : hits) {
                    ...
                    if (titleField != null) {
                        post.setTitle(titleField.getFragments()[0].toString()); // titleField.getFragments() 返回的是匹配到的高亮字段数组，这里只取第一段
                    }
